...
import StellarCommandManager, { BaseCommand } from "@interstellar/StellarCommandsManager";
...
function cheatGive(item: number) {
...
class TestKitCommand extends BaseCommand {
    name = "testkit"
    alias = [""]
    testOnly = true;
    arguments = []
    ...
    constructor(ae: Autoequip) {
        super();
        this.ae = ae;
    }
    execute(option: string) {
        InterstellarQOL.logMessage("Giving testkit...")
        this.ae.giveTestkit();
    }
}
...
class Autoequip {
    ...
    constructor() {
        ...
        StellarCommandManager.registerCommand(new TestKitCommand(this));
    }
