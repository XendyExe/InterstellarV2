from .patcher import patch_badges
from .patcher import patch_html, patch_modfiledatabase, patch_errorlogger, patch_setup
...
def patchall(path, game_version):
    ...
    patch_errorlogger.patch(path)
    patch_setup.patch(path)
    patch_badges.patch(path)