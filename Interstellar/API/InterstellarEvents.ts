...
type FilterShipEntry = {id: number, ship: {color: string, hex_code: string, icon_path: string, owned: boolean, player_count: 0, saved: boolean, team_name: string, time: number}};
export class FilterShipEvent extends BaseEvent {
...
export function createEventExports() {
    ...
    exports.FilterShipEvent = FilterShipEvent;
