...
import { createModConfigurationExports } from "./ModConfiguration";
...
export function revealInterstellarExports() {
    ...
    scriptingModExports["@interstellar/ModConfiguration"] = createModConfigurationExports();
    ...
    // @ts-ignore
    window.StellarExports = scriptingModExports
    // @ts-ignore
